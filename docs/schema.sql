...
CREATE TABLE user_profiles (
    ...
    employment_status  VARCHAR(16)  NOT NULL COMMENT 'jobCd 1개 (REC 취업 15점)',
    education_level    VARCHAR(16)  NOT NULL COMMENT 'schoolCd 1개 (REC 학력 10점)',
...
-- ------------------------------------------------------------
-- 13. search_logs — 검색 로그 (ERDCloud `검색용 로그`)
