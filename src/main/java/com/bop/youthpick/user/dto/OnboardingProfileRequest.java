...
/**
 * categories/keywords/major/specialCondition은 온보딩 화면에서 체크박스로 다중 선택되는 값이라 콤마 문자열이 아니라 배열로 받는다. 콤마
 * 결합(저장 포맷)은 서비스 계층 책임이다. categories는 대분류 5개 중 최대 3개, keywords는 전체 19개 중 선택.
 */
