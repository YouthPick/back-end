...
/**
 * 공통 에러 응답 계약. 프론트가 {@code code} 기준으로 메시지를 매핑할 수 있도록
 * 모든 에러 응답은 {@code code}를 필수로 포함한다. validation 실패 시 {@code errors}에
 * 필드 단위 상세가 담긴다.
 * 예시보고 이해하시면 됩니다.
 *  POST /api/v1/users   body:
 *  {"username":"hong","password":"","email":"hong@a.com"}
 *  {
 *      "status": 400,
 *      "code": "C001",
 *      "message": "입력 형태가 올바르지
 *      "errors": [
 *          { "field": "password", "value": "", "reason": "비밀번호는 필수입니다." }
 *      ],
